...
const LoginPage = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      alert('Google OAuth integration will be implemented with actual Google OAuth library in production.');
      ...
      // 5. We send token to our backend
  ...
  const handleGitHubLogin = async () => {
    ...
    try {
      // Similar to Google, this would integrate with GitHub OAuth
      alert('GitHub OAuth integration will be implemented with actual GitHub OAuth library in production.');
            ...
            {!isLogin && (
              <>
                ...
                <div>
                  ...
                  >
                    <option value="writer">Writer - Can create and edit articles</option>
                    <option value="editor">Editor - Can review and publish articles</option>
